...
impl <P: std::fmt::Debug + Copy, const A: uszie, const B: usize> From<[P; B]; A> for Data<P, 2> {
...
impl <P: std::fmt::Debug + Copy, const A: usize, const B: usize, const C: usize> From <[[[P; C]; B]; A]> for Data<P, 3> {
